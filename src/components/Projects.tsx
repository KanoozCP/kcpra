  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-[#E5E5E5] p-5 shadow-sm flex flex-col gap-4 mb-6">
        <div>
          <h3 className="text-base font-bold text-[#1A1A1A]">Projects</h3>
          <p className="text-xs text-gray-500 mt-0.5">Master project directory, schedules, status tracking, and manpower requisitions</p>
        </div>
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              <select
                ...
                className="px-2.5 py-1.5 bg-white border border-[#E5E5E5] rounded-xl text-[11px] font-bold text-[#333] outline-none cursor-pointer hover:bg-slate-50 opacity-100"
              >
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              <button 
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-indigo-700 border border-indigo-100 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors shrink-0"
              >
